                  ...
                  <div class="container-fluid">
                     <div class="row column_title">
                        <div class="col-md-12">
                           ...
                           <h2>Admin Tambah Data Kegiatan Rumah Tadabbur Qur'an Kuningan</h2>
                           </div>
                        </div>
                     </div>
                     <!-- row -->
                        ...
                        <div class="col-md-12">
                           <div class="white_shd full margin_bottom_30">
                              ...
                              <div class="table_section padding_infor_info">
                                 <form action="kegiatan_tambah_act.php" method="POST" enctype="multipart/form-data">
                                    <div class="input-group mb-3">
                                       <input type="text" name="nama_kegiatan" class="form-control" placeholder="Nama kegiatan" aria-label="Nama_kegiatan" aria-describedby="basic-addon1" required>
                                    </div>
                                    <div class="input-group mb-3">
                                       <p class="label3" style="padding-top: 9px;padding-bottom: 12px;">Keterangan :</p>
                                       <textarea class="ckeditor" id="ckedtor" type="text" name="keterangan"></textarea>
                                       <script>
