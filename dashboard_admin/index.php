                  ...
                  <div class="container-fluid">
                     <div class="row column_title">
                        <div class="col-md-12">
                           <div class="page_title">
                              <h2>Admin Anggota Rumah Tadabbur Qur'an Kuningan</h2>
                           </div>
                        </div>
                     </div>
                     <!-- row -->
                     <div class="row">
                        <div class="col-md-12 mb-4" >
                           <div class="button_block"><a href="tambah_data.php" type="button" class="btn cur-p btn-outline-success">Tambah Data</a></div>
                        </div>
                        <!-- table section -->
                        <div class="col-md-12">
                                       ...
                                       <tbody>
                                          ...
                                          ?>
                                             <tr>
                                                ...
                                                <td>
                                                   <img src="images/anggota/<?php echo $data['foto'] ?>" alt="" style="object-fit: contain; height: 50px;"> 
                                                </td>
                                                <td>
                                                   <a href= "update.php?id=<?php echo $data['id']; ?>"><button class="bg-gradient-warning"><span class="button_top_table" style="border: 1px solid #ffc107">Ubah</span></button></a>
                                                   <a onclick="return confirm('Anda Yakin Akan Mengahapus Data Ini ??')" href= "anggota_hapus.php?id=<?php echo $data['id']; ?>"><button class="bg-gradient-danger"><span class="button_top_table" style="border: 1px solid #dc3545">Hapus</span></button></a></td>
                                             </tr>
                                          <?php } ?>
                                       </tbody>
                                    </table>
